...
mutable struct SingleModeCoherentTDVP
    ...
    function SingleModeCoherentTDVP(order::Int)
        ...
        self.ad = Matrix{ComplexF64}(undef, order+1, order)
        ...
        self.ad2_a2 = Matrix{ComplexF64}(undef, order+1, order)
...
function (prob::SingleModeCoherentTDVP)(du, u, p, t)
    ...
    # Problem Here!
    trY = (transpose(@view(prob.L[end, :])) - prob.polα *@view(prob.L[1:end-1, :]))*@view(B[:, end])
